...
Previous approaches for cattle BCS prediction can be divided into those that modeled with 2D images and those that modeled with depth images. Some approaches based on 2D images have used active shape models based on appearance (Azzaro et al. 2011) or contour (Weber et al., 2020), fitted parabolic shapes to top-down views of cows (Halachmi et al. 2013), and . Some approaches based on depth images used the animals' topology to engineer features for further processing by models (Spoliansky et al., 2016, Liao and Krukowski, 2017), using 3D morphological techniques to measure an animal's angularity/bonyness (Hansen et al., 2018), and 
